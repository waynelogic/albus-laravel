...
import { SectionHeader, Swiper, SwiperSlide } from "@/components/ui";
...
const timeline = [
    {
        ...
        description: "Открытие компании, получение статуса франчайзи 1С, начало работы с розничными магазинами.",
        date: "Аперь 2018",
        dateTime: "2018-04",
    },
    {
        name: "Запуск Web отдела, получения сертификации для выдачи ЭЦП",
        description: "Пандемия переводит всех на удаленку, активный запуск сайтов для продажи товаров онлайн",
        date: "Май 2020",
        dateTime: "2020-05",
    },
    {
...
<template>
    <AppLayout title="О нас" :breadcrumbs="breadcrumbs">
        <section class="container sm:py-40">
            <div class="max-w-2xl lg:mx-0 lg:grid lg:max-w-none lg:grid-cols-2 lg:gap-x-16 lg:gap-y-8 xl:grid-cols-1 xl:grid-rows-1 xl:gap-x-8">
                <h1 class="max-w-2xl text-5xl font-semibold tracking-tight text-balance text-gray-900 sm:text-7xl lg:col-span-2 xl:col-auto">We’re a passionate group of people building the future of ecommerce</h1>
                <div class="mt-6 max-w-xl lg:mt-0 xl:col-end-1 xl:row-start-1">
                    <p class="text-lg font-medium text-pretty text-gray-500 sm:text-xl/8">Anim aute id magna aliqua ad ad non deserunt sunt. Qui irure qui lorem cupidatat commodo. Elit sunt amet fugiat veniam occaecat fugiat aliqua. Anim aute id magna aliqua ad ad non deserunt sunt. Qui irure qui lorem cupidatat commodo.</p>
                </div>
        ...
        <div class="container grid grid-cols-1 gap-8 lg:grid-cols-4">
            <div v-for="item in timeline" :key="item.name">
                <time :datetime="item.dateTime" class="flex items-center text-sm/6 font-semibold text-primary-700">
                    <svg viewBox="0 0 4 4" class="mr-4 size-1 flex-none" aria-hidden="true">
                        <circle cx="2" cy="2" r="2" fill="currentColor" />
                    </svg>
                    {{ item.date }}
                    <span class="absolute -ml-2 h-px w-screen -translate-x-full bg-gray-900/10 sm:-ml-4 lg:static lg:-mr-6 lg:ml-8 lg:w-auto lg:flex-auto lg:translate-x-0" aria-hidden="true" />
                </time>
                <p class="mt-6 text-lg/8 font-semibold tracking-tight text-gray-900">{{ item.name }}</p>
                <p class="mt-1 text-base/7 text-gray-600">{{ item.description }}</p>
            </div>
        </div>
        <section class="container py-12">
            <div class="relative isolate overflow-hidden bg-primary-950 px-6 py-16 text-center shadow-2xl sm:rounded-3xl">
                ...
                <Swiper class="mt-10" :options="partnersSliderOpt" navigation="none">
                    <SwiperSlide v-for="i in 12">
                        <img class="max-h-12 w-full object-contain" src="https://tailwindui.com/plus-assets/img/logos/158x48/statamic-logo-white.svg" alt="Transistor" width="158" height="48" />
                    </SwiperSlide>
                </Swiper>
                ...
                <p class="relative mt-12 inline-flex rounded-full bg-gray-50 px-4 py-1.5 text-sm/6 text-gray-600 ring-1 ring-gray-900/5 ring-inset">
                    <span class="hidden md:inline">Over 2500 companies use our tools to better their business.</span>
                    <a href="#" class="font-semibold text-primary-600"><span class="absolute inset-0" aria-hidden="true" /> Read our customer stories <span aria-hidden="true">&rarr;</span></a>
                </p>
            </div>
        </section>
        ...
        <!--                <div class="relative isolate -z-10 overflow-hidden bg-linear-to-b from-indigo-100/20 pt-14">-->
        <!--                    <div class="absolute inset-y-0 right-1/2 -z-10 -mr-96 w-[200%] origin-top-right skew-x-[-30deg] bg-white shadow-xl ring-1 shadow-indigo-600/10 ring-indigo-50 sm:-mr-80 lg:-mr-96" aria-hidden="true" />-->
        <!--                    <div class="mx-auto max-w-7xl px-6 py-32 sm:py-40 lg:px-8">-->
        <!--                        <div class="mx-auto max-w-2xl lg:mx-0 lg:grid lg:max-w-none lg:grid-cols-2 lg:gap-x-16 lg:gap-y-8 xl:grid-cols-1 xl:grid-rows-1 xl:gap-x-8">-->
        <!--                            &lt;!&ndash; <h1 class="max-w-2xl text-balance text-5xl font-semibold tracking-tight text-gray-900 sm:text-7xl lg:col-span-2 xl:col-auto">We’re changing the way people connect</h1> &ndash;&gt;-->
        <!--                            <h1 class="max-w-2xl text-5xl font-semibold tracking-tight text-balance text-gray-900 sm:text-7xl lg:col-span-2 xl:col-auto">We’re a passionate group of people building the future of ecommerce</h1>-->
        <!--                            <div class="mt-6 max-w-xl lg:mt-0 xl:col-end-1 xl:row-start-1">-->
        <!--                                <p class="text-lg font-medium text-pretty text-gray-500 sm:text-xl/8">Anim aute id magna aliqua ad ad non deserunt sunt. Qui irure qui lorem cupidatat commodo. Elit sunt amet fugiat veniam occaecat fugiat aliqua. Anim aute id magna aliqua ad ad non deserunt sunt. Qui irure qui lorem cupidatat commodo.</p>-->
        <!--                            </div>-->
        ...
        <!--                        </div>-->
        <!--                    </div>-->
        <!--                    <div class="absolute inset-x-0 bottom-0 -z-10 h-24 bg-linear-to-t from-white sm:h-32" />-->
        <!--                </div>-->
        ...
        <!--                        <div v-for="item in timeline" :key="item.name">-->
        <!--                            <time :datetime="item.dateTime" class="flex items-center text-sm/6 font-semibold text-indigo-600">-->
        <!--                                <svg viewBox="0 0 4 4" class="mr-4 size-1 flex-none" aria-hidden="true">-->
        <!--                                    <circle cx="2" cy="2" r="2" fill="currentColor" />-->
        <!--                                </svg>-->
        <!--                                {{ item.date }}-->
        ...
        <!--                        </div>-->
        <!--                        <div class="absolute -top-24 right-0 -z-10 transform-gpu blur-3xl" aria-hidden="true">-->
        <!--                            <div class="aspect-1404/767 w-[87.75rem] bg-linear-to-r from-[#80caff] to-[#4f46e5] opacity-25" style="clip-path: polygon(73.6% 51.7%, 91.7% 11.8%, 100% 46.4%, 97.4% 82.2%, 92.5% 84.9%, 75.7% 64%, 55.3% 47.5%, 46.5% 49.4%, 45% 62.9%, 50.3% 87.2%, 21.3% 64.1%, 0.1% 100%, 5.4% 51.1%, 21.4% 63.9%, 58.9% 0.2%, 73.6% 51.7%)" />-->
        <!--                        </div>-->
        <!--                    </div>-->
        <!--                </div>-->
        ...
        <!--                        <h2 class="text-4xl font-semibold tracking-tight text-pretty text-gray-900 sm:text-5xl">We approach work as a place to make the world better</h2>-->
        ...
        <!--                            <h2 class="text-3xl font-semibold tracking-tight text-pretty text-gray-900 sm:text-4xl">We’re always looking for awesome people to join us</h2>-->
        ...
        <!--                                        <dd class="mt-2 w-full flex-none text-base/7 text-gray-600">{{ opening.description }}</dd>-->
