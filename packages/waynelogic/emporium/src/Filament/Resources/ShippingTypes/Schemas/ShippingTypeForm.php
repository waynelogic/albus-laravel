...
namespace Waynelogic\Emporium\Filament\Resources\ShippingTypes\Schemas;
...
class ShippingTypeForm
{
    ...
    {
        $arProviders = self::getShippingProviders();
        return $schema->components([
            Section::make('Основное')->schema([
                ...
                TextInput::make('code')
                    ...
                    ->dehydrated()
                    ->maxLength(255)
                    ->unique(ShippingType::class, 'code', ignoreRecord: true),
                ToggleActive::make(),
    ...
    private static function getShippingProviders()
    {
        return [];
    }
}
